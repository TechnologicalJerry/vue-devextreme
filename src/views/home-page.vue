    ...
    <div class="content-block">
      <div class="dx-card responsive-paddings">
        <div class="logos-container">
          ...
          <svg class="vue-logo" viewBox="0 0 180 62" xmlns="http://www.w3.org/2000/svg">
            ...
            <g>
              <path style="fill:#35495E;" d="M77.2,15c0-0.4,0.2-0.8,0.7-1c0.5-0.3,0.9-0.4,1.4-0.4c0.7,0,1.1,0.3,1.3,0.8l7.2,24.4L95,14.4
              ...
              <path style="fill:#35495E;" d="M99.8,36V25.4c0-0.3,0.2-0.6,0.5-0.9c0.3-0.2,0.7-0.4,1.2-0.4c0.4,0,0.8,0.1,1.2,0.4
              ...
              <path style="fill:#35495E;" d="M119.9,35.9v-4.3c0-2.1,0.8-3.9,2.4-5.5c1.6-1.5,3.5-2.3,5.8-2.3c2.1,0,4,0.7,5.5,2.1
              ...
              <path style="fill:#35495E;" d="M143,51.4c0-0.5,0.1-0.8,0.4-1.1c0.3-0.3,0.6-0.4,1-0.4c1.1,0,1.8-0.4,2.1-1.2
              ...
              <path style="fill:#35495E;" d="M154.1,40.8c0-0.4,0.1-0.7,0.3-1c0.2-0.3,0.5-0.5,0.8-0.5c0.2,0,0.5,0.2,0.9,0.5s1,0.7,1.8,1
        ...
        <p>This application was built using <a href="https://cli.vuejs.org/" target="_blank" rel="noopener noreferrer">Vue
            CLI</a>
        ...
        <ul>
          <li>
            <a href="https://js.devexpress.com/Documentation/Guide/UI_Components/DataGrid/Getting_Started_with_DataGrid/"
              target="_blank" rel="noopener noreferrer">DataGrid</a>
          </li>
          <li>
            <a href="https://js.devexpress.com/Documentation/Guide/Widgets/Form/Overview/" target="_blank"
              rel="noopener noreferrer">Form</a>
          </li>
          <li>
            <a href="https://js.devexpress.com/Documentation/Guide/Widgets/Drawer/Getting_Started_with_Navigation_Drawer/"
              target="_blank" rel="noopener noreferrer">Drawer</a>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <a href="https://js.devexpress.com/Documentation/Guide/Vue_Components/Application_Template/#Layouts"
              target="_blank" rel="noopener noreferrer">Layouts</a>
          </li>
          <li>
            <a href="https://js.devexpress.com/Documentation/Guide/Vue_Components/Application_Template/#Add_a_New_View"
              target="_blank" rel="noopener noreferrer">Add a New View</a>
          </li>
          <li>
            <a href="https://js.devexpress.com/Documentation/Guide/Vue_Components/Application_Template/#Configure_the_Navigation_Menu"
              target="_blank" rel="noopener noreferrer">Configure the Navigation Menu</a>
          </li>
          <li>
            <a href="https://js.devexpress.com/Documentation/Guide/Vue_Components/Application_Template/#Configure_Themes"
              target="_blank" rel="noopener noreferrer">Configure Themes</a>
          </li>
        </ul>
        <p>
          ...
          our <a href="https://js.devexpress.com/documentation/" target="_blank" rel="noopener noreferrer">online
            documentation</a>
          and <a href="https://js.devexpress.com/Demos/Widgetsgallery/" target="_blank"
            rel="noopener noreferrer">technical demos</a>.
        </p>
      </div>
    </div>
  </div>
